...
const Profile = () => {
  ...
  const {data:Followers}=useFollowedCount({ userId: id });
  const {data:Followering}=useFollowCount({ userId: id });
  ...
  async function handleClick() {
    if (isFollow) {
      ...
      try {
        ...
        if (!newFollow) {
          throw new Error("Failed to follow this page");
        }
        setIsFollow(true);
      } catch (error) {
        console.error(error);
    ...
    <div className="profile-container">
        ...
        <div className="flex xl:flex-row flex-col max-xl:items-center flex-1 gap-7">
          ...
          <div className="flex flex-col flex-1 justify-between md:mt-2">
            ...
            <div className="flex gap-8 mt-10 items-center justify-center xl:justify-start flex-wrap z-20">
              ...
              <StatBlock value={Followers||0} label="Followers" />
              <StatBlock value={Followering||0} label="Following" />
            </div>
          ...
          <div className="flex justify-center gap-4">
            ...
            <div className={`${user.id === id && "hidden"}`}>
              ...
              >
                {isFollowing || (isUnFollowing && <Loader />)}
      ...
      <Routes>
        ...
        {currentUser.$id === user.id && (
          <Route
            path="/liked-posts"
            element={<LikedPosts currentUserId={currentUser.$id} />}
          />
        )}
      </Routes>
      <Outlet />
